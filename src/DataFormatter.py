...
"""
    ...
    Parameters:
    - input_file_path: The path of the output CSV file generated by this code.
...
"""
    Formats the `Account Review.CSV` file to an appropriate format for the B&M Spreadsheet

    Parameters:
    - output_file_path: The path of the Energy Manager CSV

    Returns:
    None
"""
def format_energy_manager(output_file_path):
    # Open file
